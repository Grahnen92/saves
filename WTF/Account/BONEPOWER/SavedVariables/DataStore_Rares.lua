...
DataStore_RaresDB = {
	...
	["global"] = {
		["Characters"] = {
			...
			["Default.Kazzak.Cazh"] = {
				["lastUpdate"] = 1603344927,
			},
			["Default.Defias Brotherhood.Rektar"] = {
				["lastUpdate"] = 1603344812,
			},
			["Default.Ravencrest.Dryda"] = {
				["lastUpdate"] = 1620466104,
			},
			...
			["Default.Defias Brotherhood.Odöde"] = {
				["lastUpdate"] = 1605128342,
			},
			["Default.Kazzak.Gladwin"] = {
				["lastUpdate"] = 1610432120,
			},
			["Default.Ravencrest.Rever"] = {
				["lastUpdate"] = 1620823431,
				["Rares"] = {
					[130143] = {
						["resetTime"] = 65768,
						["name"] = "Balethorn",
