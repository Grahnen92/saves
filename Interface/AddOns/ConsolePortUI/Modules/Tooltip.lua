...
function Tooltip:OnShow()
	UI.Data.UIFrameFadeIn(self, 0.2, 0, 1)
...
function UI:GetTooltip()
	...
	if not tooltip then
		...
		tooltip = UI:CreateFrame('GameTooltip', CP_UI..'Tooltip'..id, UIParent, 'GameTooltipTemplate', {
		...
		tooltip.Button:SetHighlightTexture(tooltip.Button.HilightTexture)
		tooltip.Button:SetNormalTexture(tooltip.Button.Normal)
		tooltip.Button:SetCheckedTexture(tooltip.Button.Checked)
